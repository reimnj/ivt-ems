...
if(isset($_POST['create-dept'])) {
    ...
    $query = "INSERT INTO department(departmentID, department_name) VALUES ('$deptID', '$deptName')";
    $executeQuery = mysqli_query($connection, $query);
    header("Location:department_add.php?success=true");
}
...
<head>
    ...
    <title>EMS New Department</title>
</head>
<body>
    <div class="sidebar">
                ...
                <div class="notice-content">
                    <form action="" method="post">
                        ...
                        <div class="notice-footer">
                            ...
                            <input type="submit" name="create-dept" value="Create Department">
                        </div>
